/**
 * TODO:
- submit from TitleSearch apply to AdvancedSearch
- multiple select returning only one actual string value
- toggle button returning all selected values
- handler needs to be reimplement to append to array
- reimplement toggle button to get only last value
 */
